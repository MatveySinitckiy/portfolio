...
function Works({img,name,link}){
    return<>
    <div className="md:w-[90%]  w-[90vw] h-[70%] md:h-[60%]  mb-[10%] bg-white/5 shadow-2xl shadow-stone-900/50 p-[1.5vmin] hover:bg-black/55 hover:shadow-black/55 transition-all  rounded-3xl flex flex-col items-center" >
